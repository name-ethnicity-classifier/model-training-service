...
VALUES
        (
                ...
                true,
                true,
                '3_nationality_groups',
                '2021-10-14 16:44:00',
                '08205d420e9342228e68'
        );
...
VALUES
        (
                78.51,
                '{else,british,indian,spanish,german,italian,french,chinese,japanese,dutch,russia}',
                ...
                false,
                true,
                '10_nationalities_and_else',
                '2021-09-07 12:11:00',
                '8129a4fb8a3f0d7f9e4c'
        );
...
VALUES
        (
                null,
                '{angloAmerican,hispanic,scandinavian,arabic}',
                null,
                false,
                true,
                true,
                '4_nationality_groups',
                '2021-10-14 16:44:00',
                'dummy-id-2'
        );
...
VALUES
        (
                78.51,
                '{british,indian,german,italian,french,chinese,japanese}',
